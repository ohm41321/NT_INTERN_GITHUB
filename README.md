...
2.  **Logic Layer (Guard Model):** Classifier ขนาดเล็กที่ทำหน้าที่ตรวจสอบว่าคำถามเกี่ยวข้องกับโปรโมชั่น NT หรือไม่
3.  **Orchestration Layer:** Gemini 2.0 Flash วิเคราะห์เจตนา (Intent) และตัดสินใจว่าจะเรียกใช้เครื่องมือ `search_home_internet` หรือ `search_mobile_internet`
...
## 📧 ติดต่อและรายละเอียด (Contact)
โปรเจกต์นี้พัฒนาขึ้นโดยเป็นส่วนหนึ่งของความคิดริเริ่มในการยกระดับบริการลูกค้าด้วย AI
- **ผู้จัดทำ:** [ชื่อของคุณ/ทีม]
- **ประเภทโปรเจกต์:** การฝึกงาน / Portfolio Showcase
- **สถานะ:** พร้อมใช้งานจริง (Production-Ready MVP)
